(function() {
  ...
  function TimeChartController($element, d3, dc, NdxService, HelperFunctions, Messagebus) {
    this.initializeChart = function() {
      var seriesChart = dc.seriesChart('#'+$element[0].children[0].attributes.id.value);
  ...
  angular.module('uncertApp.charts').controller('TimeChartController', TimeChartController);
})();
