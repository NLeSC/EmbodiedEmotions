...
(function() {
  ...
  angular.module('uncertApp.core')
    ...
    .constant('uncertConf', {
      ...
      // DATA_JSON_URL: 'https://raw.githubusercontent.com/NLeSC/UncertaintyVisualization/narratives/app/data/annotation18.json'
      DATA_JSON_URL: 'https://raw.githubusercontent.com/NLeSC/EmbodiedEmotions/narratives/app/data/annotation05-02.json'
    });
})();
